...
function initial_action(x, y, f, φ)
...
output_suffix = use_averaging ? "_averaged" : ""
...
let
    ...
    save(joinpath(output_dir, "garden_sprinkler_Hs_t5d$(output_suffix).png"), fig)
    @info "Hs map written" path = joinpath(output_dir, "garden_sprinkler_Hs_t5d$(output_suffix).png")
end
...
let
    ...
    movie_path = joinpath(output_dir, "garden_sprinkler$(output_suffix).mp4")
